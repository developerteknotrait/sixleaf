...
public class Helper {
	...
	/*
	 * 
	 * This will return a random 10 digit number.**@return
	 */
	 ...
	 * @param pixel
	 */
	public static void scrollInsidePopup(int pixel, WebDriver driver) {
		...
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollTop = arguments[1];",
				driver.findElement(By.xpath("//md-dialog-content")), pixel);
	 ...
	 * @param pixel
	 */
	public static void scroll(int pixel, WebDriver driver) {
	...
	public static String getUniqueEmail() {
		...
		Date date = new Date();
		String uniqueValue = (String) dateFormat.format(date);
		return "testmail" + uniqueValue + "@domain.com";
	}
}
