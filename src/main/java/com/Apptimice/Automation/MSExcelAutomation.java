...
public class MSExcelAutomation {
	...
	// returns true if data is set successfully else false - mainly used for writing result link in the sheet
	public boolean setCellData(String sheetName, String colName, int rowNum, String data, String url){
		...
		try{
			...
			// cell style for hyper links and by default hyper links are blue and underlined
