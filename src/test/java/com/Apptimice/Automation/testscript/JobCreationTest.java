...
public class JobCreationTest extends TestBase {
	...
	public void jobCreationTest(String date, String description, String pickUpAddress, String zone, String skill,
			String duration, String weight, String volume, String notes, String driver, String vehicle, String jobtype, String deliveryAddress, String deliveryDuration, String deliveryStart, String deliveryEnd, String deliverySkill, String deliveryZone)
		 ...
		 * 
		 * dateWidget.click(); dateWidget.sendKeys("12");
		 */
		...
		Thread.sleep(5000);
		/*
		 * // Check on the screen as if the job has been added.
		 * 
		 * Assert.assertTrue(WebUIAutomation.isObjPresent(
		 * "//*[@id='tblJobsList']/tbody/tr", 10),
		 * "Unable to Visualize Job created");
		 */
	}
