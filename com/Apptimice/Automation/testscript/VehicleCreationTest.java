...
public class VehicleCreationTest extends TestBase {
	...
	public void vehicleCreationTest(String vehicleNumber, String startAddress, String endAddress, String weight, String volume, String vehicleType, String zone) throws InterruptedException {
		...
		WebElement showMoreOPtion = wbDv.findElement(
				By.xpath("//a[@class = 'link vehicle-options' and @data-value = 'showmore']"));
		...
		WebElement vehicleTypeSelInput = (WebElement)executor.executeScript("return arguments[0].parentNode", vehicleTypeElement);
		List<WebElement> childInputs = vehicleTypeSelInput.findElements(By.xpath("//input[@class='select2-input select2-default']"));
		...
		List<WebElement> zoneChildInputs = zoneSelInput.findElements(By.xpath("//input[@class='select2-input select2-default']"));
		...
		//Assert.assertTrue(WebUIAutomation.clickObj("Text_CategorizationOfVehicle_AddVehicleScreen"),"Unable to click on the Text of Vehicle Type");
