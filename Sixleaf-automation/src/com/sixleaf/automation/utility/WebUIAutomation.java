package com.sixleaf.automation.utility;
...
public static String getMsg(String xpathKey) {
 ...
 /**
	...
	public static boolean checkTestCaseRunmode(String testCase){
		...
		for(int i=2; i<=datatable.getRowCount("Sixleaf"); i++){
			
			if(datatable.getCellData("Sixleaf", "Test Case ID", i).equalsIgnoreCase(testCase)){
				
				if(datatable.getCellData("Sixleaf", "Runmode", i).equalsIgnoreCase("Y")){
